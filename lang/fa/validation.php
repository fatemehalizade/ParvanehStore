...
return [
    ...
    */
    'attributes' => [
		...
		"file" => "فایل",
        "tagName" => "نام برچسب",
        "packageTypeName" => "نوع بسته بندی موادغذایی",
        "producerName" => "نام تولید کننده موادغذایی" ,
        "brandName" => "نام برند موادغذایی",
        "categoryName" => "نام دسته موادغذایی",
        "categoryNickName" => "نام لاتین دسته موادغذایی",
        "productName" => "نام موادغذایی" ,
        "count" => "تعداد موادغذایی" ,
        "price" => "قیمت موادغذایی" ,
        "weight" => "وزن موادغذایی" ,
        "healthLicenceNumber" => "شماره پروانه بهداشت موادغذایی" ,
        "categoryId" => "دسته موادغذایی" ,
        "brandId" => "برند موادغذایی" ,
        "packageTypeId" => "نوع بسته بندی موادغذایی" ,
        "producerId" => "تولیدکننده موادغذایی" ,
        "tags" => "برچسب های موادغذایی" ,
        "galleryPhotos" => "گالری تصاویر موادغذایی" ,
        "description" => "توضیحات" ,
        "percent" => "درصد تخفیف موادغذایی" ,
        "startDate" => "تاریخ شروع تخفیف موادغذایی" ,
        "finishDate" => "تاریخ پایان تخفیف موادغذایی" ,
        "productId" => "محصول" ,
        "mobileNumber" => "شماره موبایل" ,
        "phoneNumber" => "شماره تلفن ثابت",
        "URL" => "آدرس شبکه اجتماعی",
        "message" => "پیام",
        "comment" => "نظر",
        "commentId" => "آیدی ریپلای"
    ],
];
